<template>
  <div>
    <!--模拟的标题-->
    <p class="header">
      <router-link class="btn-left" to="/mescroll">main</router-link>商品列表
    ...
    <div ref="mescroll" class="mescroll">
      <div class="notice">
        ...
        <br />
        <p @click="isEdit = !isEdit" class="btn-change">
          模拟后台修改商品信息{{ isEdit }}
        </p>
      </div>
      <!--展示上拉加载的数据列表-->
...
import mockDataEdit from '~/static/mescroll/mock/pdlistEdit'
  ...
  mounted() {
    ...
    this.mescroll = new MeScroll(this.$refs.mescroll, {
      ...
      up: {
        ...
        toTop: {
          // 配置回到顶部按钮
          src: '~/assets/mescroll/mescroll-totop.png'
        },
        lazyLoad: {
